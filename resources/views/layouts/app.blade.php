    ...
    <div class="w-70">
        <div class="">
            <ul class="list text-right">
                <li class="inline-block mx-3"><a class="text-white no-underline" href="{{ route('page.home') }}">Home</a></li>
                ...
                <li class="inline-block mx-3"><a class="text-white no-underline" href="{{ route('articles.index') }}">Articles</a></li>
